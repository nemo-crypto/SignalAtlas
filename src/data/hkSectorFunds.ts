...
export const hkFundDataNote =
  "内置港股 ETF 基金池仅用于板块/细分领域归类；走势优先由腾讯港股 ETF 日 K 实时覆盖，接口不可用时才使用本地降级样本。";

function buildFallbackTrend(changePercent: number, periodName: string): HkFundTrend {
  const start = 100 / (1 + changePercent / 100);
  ...
  const series = Array.from({ length: pointCount }, (_, index) => {
    ...
    const wave = Math.sin(index * 0.9) * Math.min(Math.abs(changePercent) * 0.08, 1.4);
    return Number((start + (100 - start) * progress + wave).toFixed(2));
  });
...
function buildFallbackTrends(
  ...
  month: number,
  year: number
): Record<HkFundTrendPeriod, HkFundTrend> {
  return {
    week: buildFallbackTrend(week, "周线"),
    month: buildFallbackTrend(month, "月线"),
    year: buildFallbackTrend(year, "近一年")
  };
}
    ...
    funds: [
      {
        ...
        trends: buildFallbackTrends(0.9, 2.8, 8.6)
      },
      {
        code: "03115",
        name: "安硕恒生指数",
        ...
        trends: buildFallbackTrends(0.7, 2.3, 7.9)
      },
      {
        code: "02828",
        name: "恒生中国企业",
        ...
        trends: buildFallbackTrends(1.1, 3.1, 9.4)
      },
      {
        code: "03167",
        name: "工银南方中国",
        ...
        trends: buildFallbackTrends(0.4, 1.8, 5.2)
      }
    ]
  },
  {
    ...
    funds: [
      {
        ...
        trends: buildFallbackTrends(1.8, 5.6, 18.4)
      },
      {
        code: "03067",
        name: "安硕恒生科技",
        ...
        trends: buildFallbackTrends(1.6, 5.2, 16.8)
      },
      {
        code: "03032",
        name: "恒生科技ETF",
        ...
        trends: buildFallbackTrends(1.5, 4.9, 15.7)
      },
      {
        code: "02837",
        name: "GX恒生科技",
        ...
        trends: buildFallbackTrends(1.4, 4.6, 14.9)
      }
    ]
  },
  {
    ...
    funds: [
      {
        ...
        trends: buildFallbackTrends(0.6, 2.2, 7.4)
      },
      {
        code: "03188",
        name: "华夏沪深三百",
        ...
        trends: buildFallbackTrends(0.5, 2.0, 6.8)
      },
      {
        code: "02846",
        name: "安硕沪深三百",
        ...
        trends: buildFallbackTrends(0.4, 1.9, 6.5)
      },
      {
        code: "03040",
        name: "GX中国",
        ...
        trends: buildFallbackTrends(0.2, 1.5, 4.8)
      }
    ]
  },
  {
    ...
    funds: [
      {
        ...
        trends: buildFallbackTrends(-0.1, 1.1, 6.1)
      },
      {
        code: "03070",
        name: "平安香港高息",
        ...
        trends: buildFallbackTrends(-0.2, 0.8, 4.6)
      },
      {
        code: "03403",
        name: "华夏恒ESG",
        ...
        trends: buildFallbackTrends(0.3, 1.6, 5.4)
      }
    ]
  },
  {
    ...
    funds: [
      {
        ...
        trends: buildFallbackTrends(0.8, 3.7, 22.4)
      },
      {
        code: "03081",
        name: "价值黄金",
        ...
        trends: buildFallbackTrends(0.7, 3.2, 20.6)
      },
      {
        code: "03141",
        name: "华夏亚投债",
        ...
        trends: buildFallbackTrends(0.1, 0.7, 3.2)
      },
      {
        code: "03086",
        name: "华夏纳指",
        ...
        trends: buildFallbackTrends(1.0, 4.1, 19.5)
      }
    ]
  }
];
